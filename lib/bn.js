...
Red.prototype.neg = function neg(a) {
  var r = a.clone();
  r.sign = !r.sign;
  return r.iadd(this.m).forceRed(this);
};
...
Red.prototype.iadd = function iadd(num) {
  this._verify2(a, b);
...
Red.prototype.sub = function sub(num) {
  this._verify2(a, b);
...
Red.prototype.isub = function isub(num) {
  this._verify2(a, b);
...
Red.prototype.shl = function shl(a, num) {
  this._verify1(a);
  return a.shln(num).mod(this.m).forceRed(this);
};

Red.prototype.mul = function mul(a, b) {
  this._verify2(a, b);
  return a.mul(b).mod(this.m).forceRed(this);
};
...
Red.prototype.invm = function invm(a) {
  return a.invm(this.m).forceRed(this);
};
...
Mont.prototype.convertTo = function convertTo(num) {
  return num.shln(this.shift).mod(this.m);
};

Mont.prototype.convertFrom = function convertFrom(num) {
  return num.mul(this.rinv).mod(this.m);
};

Mont.prototype.mul = function mul(a, b) {
  if (a.cmpn(0) === 0 || b.cmpn(0) === 0)
    return new BN(0).forceRed(this);
...
Mont.prototype.invm = function invm(a) {
  ...
  var res = a.invm(this.m).mul(this.r2).mod(this.m);
  return res.forceRed(this);
};
