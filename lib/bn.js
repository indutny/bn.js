  ...
  */
  ...
  BN.prototype.toString = function toString (base, padding) {
    ...
    if (base === (base | 0) && base >= 2 && base <= 36) {
      ...
      c.negative = 0;
      while (!c.isZero()) {
        var r = c._modn(groupBase).toString(base);
        c = c.idivn(groupBase);
  ...
  BN.prototype.imodn = function imodn (num) {
    this.words[0] = this._modn(num);
    this.length = 1;
    return this;
  };

  BN.prototype.modn = function modn (num) {
    // NOTE: this should be faster than clone
    return new BN(this._modn(num));
  };

  BN.prototype._modn = function _modn (num) {
