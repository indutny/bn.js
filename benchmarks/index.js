...
while (fixtures.length < 25) {
  ...
  fixture.as6 = fixture.a6.multiply(fixture.a6).add(new BigInteger('2adbeef', 16));
  fixture.as8 = fixture.a8.multiply(fixture.a8).add(SilentMattBigInteger.parse('2adbeef', 16));
